...
export default function FeaturesSection() {
    ...
    const features: Feature[] = [
        {
            title: t("Giám sát thời gian thực"),
            description: t(
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    <h2 className="text-base font-semibold leading-7 text-purple-600">
                        {t("Giám sát hệ thống thông minh")}
                    </h2>
                    <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                        {t("Kiểm soát toàn diện hệ thống Modobom")}
                    </p>
                    <p className="mt-6 text-lg leading-8 text-gray-600">
                        {t(
                            "Hệ thống giám sát và quản lý nội bộ giúp theo dõi, phân tích và tối ưu hóa hoạt động của Modobom một cách hiệu quả."
                        )}
                    </p>
                </div>
