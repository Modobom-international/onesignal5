                        ...
                        <div className="lg:col-span-6 lg:flex lg:flex-col lg:justify-center">
                            <div className="max-w-xl space-y-8">
                                ...
                                <p className="mt-6 text-lg leading-8 text-gray-600">
                                    Theo dõi, quản lý và tối ưu hóa hoạt động
                                    của hệ thống Modobom. Giám sát người dùng,
                                    phân tích hành vi và đảm bảo an toàn dữ
                                    liệu.
                                </p>
...
const WindowHeader = () => (
    <div className="relative rounded-t-2xl bg-slate-800 p-3">
        <div className="flex items-center justify-between">
            ...
            <div className="text-xs text-slate-400">modobom-system-monitor</div>
        </div>
    </div>
);
        ...
        <div className="rounded-lg bg-white p-4 shadow-sm ring-1 ring-slate-900/5">
            <div className="mb-4 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs text-slate-500">Đang ghi</span>
                </div>
            </div>
            <div className="space-y-2 font-mono text-xs">
                ...
                <div className="p-2 bg-slate-50 rounded">
                    ...
                    <span className="text-slate-700">
                        Kiểm tra kết nối domain modobom.com
                    </span>
                </div>
                <div className="p-2 bg-slate-50 rounded">
