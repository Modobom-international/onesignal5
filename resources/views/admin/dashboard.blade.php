...
<div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1 row">
    <div class="col-xl-3 metrics-item">
        <div class="white_card card_height_100 mb_30">
            <div class="white_card_header">
                <div class="box_header m-0">
                    <div class="main-title">
                        <h3 class="m-0">Số liệu hàng đợi Log Behavior</h3>
                    </div>
                </div>
            </div>
            <div class="white_card_body">
                ...
                <div class="monthly_plan_wraper">
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        ...
                        <span class="brouser_btn" id="log-behavior-length">{{ $data['create_log_behavior']['length'] }}</span>
                    </div>
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        <div class="plan_left d-flex align-items-center">
                            <div class="thumb">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M2 10a8 8 0 1116 0 8 8 0 01-16 0zm5-2.25A.75.75 0 017.75 7h.5a.75.75 0 01.75.75v4.5a.75.75 0 01-.75.75h-.5a.75.75 0 01-.75-.75v-4.5zm4 0a.75.75 0 01.75-.75h.5a.75.75 0 01.75.75v4.5a.75.75 0 01-.75.75h-.5a.75.75 0 01-.75-.75v-4.5z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
                            <div>
                        ...
                        <span class="brouser_btn" id="log-behavior-runtime">{{ number_format($data['create_log_behavior']['runtime'], 0) }}</span>
                    </div>
                    ...
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        ...
                        <span class="brouser_btn" id="log-behavior-processes">{{ $data['create_log_behavior']['processes'] }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="white_card_body">
                ...
                <div class="monthly_plan_wraper">
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        ...
                        <span class="brouser_btn" id="html-source-length">{{ $data['create_html_source']['length'] }}</span>
                    </div>
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        <div class="plan_left d-flex align-items-center">
                            <div class="thumb">
                        ...
                        <span class="brouser_btn" id="html-source-runtime">{{ number_format($data['create_html_source']['runtime'], 0) }}</span>
                    </div>
                    ...
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        ...
                        <span class="brouser_btn" id="html-source-processes">{{ $data['create_html_source']['processes'] }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="white_card_body">
                ...
                <div class="monthly_plan_wraper">
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        ...
                        <span class="brouser_btn" id="users-tracking-length">{{ $data['create_users_tracking']['length'] }}</span>
                    </div>
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        <div class="plan_left d-flex align-items-center">
                            <div class="thumb">
                        ...
                        <span class="brouser_btn" id="users-tracking-runtime">{{ number_format($data['create_users_tracking']['runtime'], 0) }}</span>
                    </div>
                    ...
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        ...
                        <span class="brouser_btn" id="users-tracking-processes">{{ $data['create_users_tracking']['processes'] }}</span>
                    </div>
                </div>
            </div>
        </div>
