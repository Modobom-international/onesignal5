                            ...
                            <x-table.body>
                                @foreach($domains as $domain)
                                    <x-table.row>
                                        ...
                                        <x-table.cell>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $domain->status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                                {{ $domain->status ? __('Hoạt động') : __('Không hoạt động') }}
                                            </span>
                                        </x-table.cell>
                                        <x-table.cell class="text-right space-x-2">
                                            <button type="button"
                                                data-total='@json($domain)'
                                                data-bs-toggle="modal"
                                                data-bs-target="#modalDetailDomain"
                                            ...
                                            @if(Auth::user()->email == 'vutuan.modobom@gmail.com' or Auth::user()->email == 'tranlinh.modobom@gmail.com')
                                                <button type="button"
                                                    ...
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#modalDeleteDomain"
