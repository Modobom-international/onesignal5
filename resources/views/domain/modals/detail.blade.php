<!-- Detail Modal -->
<div id="modalDetailDomain" tabindex="-1" aria-hidden="true"
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <dd class="mt-1">
                            <span id="status-modal" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium">
                            </span>
                        </dd>
                    </div>
                </div>
